...
EDIT = SVG_TEMPLATE.format(height="24", color="rgb(255,255,255)", data="M288.46-220q-28 0-48.23-20.23Q220-260.46 220-288.46q0-13.08 5.04-25.27t15.5-22.65l383.08-383.08q10.46-10.46 22.84-15.5 12.39-5.04 25.46-5.04 28 0 48.04 20.04T740-671.54q0 13.08-4.73 25.58-4.73 12.5-14.81 22.96L337-239.92q-10.08 10.46-22.46 15.19-12.39 4.73-26.08 4.73Z")
...
MENU_LOGIN = SVG_TEMPLATE.format(height="24", color="rgb(255,255,255)", data="M480-120v-80h280v-560H480v-80h280q33 0 56.5 23.5T840-760v560q0 33-23.5 56.5T760-120H480Zm-80-160-55-58 102-102H120v-80h327L345-622l55-58 200 200-200 200Z")
CHEVRON_RIGHT = SVG_TEMPLATE.format(height="24", color="rgb(227,227,227)", data="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z")
...
SORT = SVG_TEMPLATE.format(height="24", color="rgb(255,255,255)", data="M336.16-453.85v-291.23L222.77-631.69 180-673.85 366.15-860l186.16 186.15-42.77 42.16-113.39-113.39v291.23h-59.99ZM593.46-100 407.31-286.15l42.77-42.16 113.38 113.39v-291.23h60v291.23l113.39-113.39 42.76 42.16L593.46-100Z")
...
<svg viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'>\
    <rect x='1' y='1' width='18' height='18' rx='2.5' fill='{bg_color}'/>\
    <rect x='1' y='1' width='18' height='18' rx='2.5' fill='{fill_color}' mask='url(%23squareMask)'/>\
    <text x='10' text-anchor='middle' y='10' dominant-baseline='central' fill='{text_color}' font-size='8' \
        style='font-family: Roboto,-apple-system,Helvetica Neue,Helvetica,Arial,sans-serif;{decoration}'\
    >{text}</text>\
    <defs><mask id='squareMask'>\
        <rect width='20' height='20' fill='white'/>\
        <rect x='1' y='1' width='18' height='{mask_height}' fill='black'/>\
    </mask></defs>\
</svg>\
"""
